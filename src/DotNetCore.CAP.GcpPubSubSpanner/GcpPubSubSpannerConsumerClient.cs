...
{
    internal sealed class GcpPubSubSpannerConsumerClient : IConsumerClient
    {
        ...
        public GcpPubSubSpannerConsumerClient(string subscriptionName, IOptions<GcpPubSubSpannerOptions> options)
        {
        ...
        public BrokerAddress BrokerAddress => new BrokerAddress("GcpPubSubSpanner", string.Empty);
