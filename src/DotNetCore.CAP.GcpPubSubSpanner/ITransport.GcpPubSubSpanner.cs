...
{
    internal class GcpPubSubSpannerTransport : ITransport
    {
        ...
        public GcpPubSubSpannerTransport(IOptions<GcpPubSubSpannerOptions> options,
            ILogger<GcpPubSubSpannerTransport> logger)
        {
            _options = options;
            _logger = logger;
