...
namespace DotNetCore.CAP.Abstractions
{
    public abstract class CapPublisherBase : ICapPublisher, IDisposable
    {
        ...
        public virtual void Publish<T>(string name, T contentObj, object mongoSession, string callbackName = null)
        {
            throw new NotImplementedException("Work for MongoDB only.");
        }

        public virtual Task PublishAsync<T>(string name, T contentObj, object mongoSession, string callbackName = null)
        {
            throw new NotImplementedException("Work for MongoDB only.");
        }
