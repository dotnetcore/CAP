...
namespace Sample.RabbitMQ.PostgreSql.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        {
            await _capBus.PublishAsync("sample.rabbitmq.postgresql", DateTime.Now, cancellationToken: HttpContext.RequestAborted);
        ...
        public async Task<IActionResult> AdonetWithTransaction()
        {
            using (var connection = new NpgsqlConnection(AppDbContext.ConnectionString))
            {
                ...
                await _capBus.PublishAsync("sample.rabbitmq.postgresql", DateTime.Now);
            }
